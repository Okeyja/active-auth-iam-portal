...
class Info extends Component<
  { loading: boolean; principalAndInfo: AdvancedProfileData; dispatch: Dispatch<any> },
  InfoState
> {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'principalAndInfo/fetchAdvanced',
    });
  }
  ...
  render() {
    ...
    const { principalAndInfo, loading } = this.props;
    const { advancedOperation1, advancedOperation2, advancedOperation3 } = principalAndInfo;
    const contentList = {
      tab1: (
        <Table
          pagination={false}
...
export default connect(
  ({
    ...
    principalAndInfo: AdvancedProfileData;
    loading: {
      effects: { [key: string]: boolean };
    };
  }) => ({
    principalAndInfo,
    loading: loading.effects['principalAndInfo/fetchAdvanced'],
  }),
)(Info);
